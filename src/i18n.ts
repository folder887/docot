...
const DICT: Dict = {
  ...
  'dow.5': { en: 'Fri', ru: 'Пт' },
  'dow.6': { en: 'Sat', ru: 'Сб' },
  'auth.createTitle': { en: 'Create account', ru: 'Регистрация' },
  'auth.loginTitle': { en: 'Log in', ru: 'Вход' },
  'auth.password': { en: 'Password', ru: 'Пароль' },
  'auth.login': { en: 'Log in', ru: 'Войти' },
  'auth.noAccount': { en: "I don't have an account", ru: 'Нет аккаунта' },
  'auth.haveAccount': { en: 'I already have an account', ru: 'Уже есть аккаунт' },
